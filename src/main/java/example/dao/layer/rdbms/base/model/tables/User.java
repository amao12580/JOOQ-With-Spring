...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = 364177560;
    ...
    /**
     * The column <code>study.user.order_sum</code>. ������
     */
    public final TableField<UserRecord, Integer> ORDER_SUM = createField("order_sum", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "������");
